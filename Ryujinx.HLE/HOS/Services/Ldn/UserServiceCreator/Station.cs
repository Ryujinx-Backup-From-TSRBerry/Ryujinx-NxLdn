...
{
    internal class Station : IDisposable
    {
        ...
        {
            ConnectRequest connectRequest = default(ConnectRequest);
            connectRequest.SecurityConfig = securityConfig;
            connectRequest.UserConfig = userConfig;
            connectRequest.LocalCommunicationVersion = localCommunicationVersion;
            connectRequest.OptionUnknown = optionUnknown;
            connectRequest.NetworkInfo = networkInfo;
        ...
        {
            ConnectPrivateRequest connectPrivateRequest = default(ConnectPrivateRequest);
            connectPrivateRequest.SecurityConfig = securityConfig;
            connectPrivateRequest.SecurityParameter = securityParameter;
            connectPrivateRequest.UserConfig = userConfig;
            connectPrivateRequest.LocalCommunicationVersion = localCommunicationVersion;
            connectPrivateRequest.OptionUnknown = optionUnknown;
            connectPrivateRequest.NetworkConfig = networkConfig;
            ConnectPrivateRequest request = connectPrivateRequest;
