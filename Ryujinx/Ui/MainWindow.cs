...
#pragma warning restore CS0649, IDE0044, CS0169
        ...
        private MainWindow(Builder builder) : base(builder.GetObject("_mainWin").Handle)
        {
            ...
            ConfigurationState.Instance.Multiplayer.EnableLan.Event        += UpdateMultiplayerEnableLan;
        ...
        private void UpdateMultiplayerEnableLan(object sender, ReactiveEventArgs<bool> args)
        {
            if (_emulationContext != null)
            {
                _emulationContext.Configuration.MultiplayerEnableLan = args.NewValue;
            }
        }
        ...
        private void UpdateColumns()
        {
            ...
            if (ConfigurationState.Instance.Multiplayer.Mode.Value != 0 &&
                ConfigurationState.Instance.Ui.GuiColumns.LdnInfoColumn)    _gameTable.AppendColumn("LDN Info",    new CellRendererText(),   "text",    5);
